...
Modified for EnvisionWare Pty. Ltd. by Stuart Loose September 2007
Added support for Envisionware Date Preferences and Language switching
Explanation of the Date Format codes:
Eg. Monday 6th September 2007
Y = 2007, y = 07, M = Sep, F = September, m = 09, n = 9, D = Mon, l = Monday, j = 06, d = 6

*****************************************************************************/
var TextString; 

//constructor for the main Epoch class 
function Epoch(name,mode,targetelement,multiselect, textLang)
{
	this.state = 0;
	this.name = name;
	...
	if(this.mode == 'popup' && targetelement && targetelement.type == 'text') //if the target element has been set to be an input text box
	{
		...
		this.isoTgt = document.getElementById("iso" + this.tgt.id);
	}
	else
	{
...
{
/*
	this.daylist = new Array( "%%Text.txtCalendar_day1_sh%%",
							  "%%Text.txtCalendar_day2_sh%%",
							  "%%Text.txtCalendar_day3_sh%%",
							  "%%Text.txtCalendar_day4_sh%%",
							  "%%Text.txtCalendar_day5_sh%%",
							  "%%Text.txtCalendar_day6_sh%%",
							  "%%Text.txtCalendar_day7_sh%%"); //<lang:en>
							  
	this.months_sh = new Array( "%%Text.txtCalendar_Month1_sh%%",
								"%%Text.txtCalendar_Month2_sh%%",
								"%%Text.txtCalendar_Month3_sh%%",
								"%%Text.txtCalendar_Month4_sh%%",
								"%%Text.txtCalendar_Month5_sh%%",
								"%%Text.txtCalendar_Month6_sh%%",
								"%%Text.txtCalendar_Month7_sh%%",
								"%%Text.txtCalendar_Month8_sh%%",
								"%%Text.txtCalendar_Month9_sh%%",
								"%%Text.txtCalendar_Month10_sh%%",
								"%%Text.txtCalendar_Month11_sh%%",
								"%%Text.txtCalendar_Month12_sh%%");
	
	this.monthup_title = "%%Text.txtCalendar_Monthup_title%%";
	this.monthdn_title = "%%Text.txtCalendar_Monthdn_title%%";
	this.clearbtn_caption = "%%Text.txtCalendar_Clearbtn_caption%%";
	this.clearbtn_title = "%%Text.txtCalendar_Clearbtn_title%%";
	this.maxrange_caption = "%%Text.txtCalendar_Maxrange_caption%%";
*/
	this.daylist = new Array( TextString.txtCalendar_day1_sh,
							  TextString.txtCalendar_day2_sh,
							  TextString.txtCalendar_day3_sh,
							  TextString.txtCalendar_day4_sh,
							  TextString.txtCalendar_day5_sh,
							  TextString.txtCalendar_day6_sh,
							  TextString.txtCalendar_day7_sh); //<lang:en>
							  
	this.months_sh = new Array( TextString.txtCalendar_Month1_sh,
								TextString.txtCalendar_Month2_sh,
								TextString.txtCalendar_Month3_sh,
								TextString.txtCalendar_Month4_sh,
								TextString.txtCalendar_Month5_sh,
								TextString.txtCalendar_Month6_sh,
								TextString.txtCalendar_Month7_sh,
								TextString.txtCalendar_Month8_sh,
								TextString.txtCalendar_Month9_sh,
								TextString.txtCalendar_Month10_sh,
								TextString.txtCalendar_Month11_sh,
								TextString.txtCalendar_Month12_sh);
	
	this.monthup_title = TextString.txtCalendar_Monthup_title;
	this.monthdn_title = TextString.txtCalendar_Monthdn_title;
	this.clearbtn_caption = TextString.txtCalendar_Clearbtn_caption;
	this.clearbtn_title = TextString.txtCalendar_Clearbtn_title;
	this.maxrange_caption = TextString.txtCalendar_Maxrange_caption;
};
//-----------------------------------------------------------------------------
...
Epoch.prototype.setDays = function ()  //PRIVATE: initializes the standard Gregorian Calendar parameters
{
	...
	for(var i=0; i< 7;i++) {
	     if (j == 7)
				j=0;
	 		this.daynames[i] = this.daylist[j++];
	}
...
CalCell.prototype.onclick = function () 
{
	...
	if(!owner.selCurMonthOnly || cell.date.getMonth() == owner.displayMonth && cell.date.getFullYear() == owner.displayYear)
	{
		...
		else //if we can only select one cell at a time
		{
			...
			{
				owner.tgt.value = owner.selectedDates[0].dateFormat('%%Preferences.DateFormat%%');
				if(owner.mode == 'popup') {
					owner.hide();
				}
			}
			...
			if(owner.isoTgt) {
			  owner.isoTgt.value = owner.selectedDates[0].dateFormat('Y-m-d');
			}
		}
...
Date.prototype.dateFormat = function(format)
{
	...
	var MONTH_NAMES = new Array( TextString.txtCalendar_Month1,
								 TextString.txtCalendar_Month2,
								 TextString.txtCalendar_Month3,
								 TextString.txtCalendar_Month4,
								 TextString.txtCalendar_Month5,
								 TextString.txtCalendar_Month6,
								 TextString.txtCalendar_Month7,
								 TextString.txtCalendar_Month8, 
								 TextString.txtCalendar_Month9,
								 TextString.txtCalendar_Month10,
								 TextString.txtCalendar_Month11,
								 TextString.txtCalendar_Month12, 
								 
								 TextString.txtCalendar_Month1_sh,
								 TextString.txtCalendar_Month2_sh,
								 TextString.txtCalendar_Month3_sh,
								 TextString.txtCalendar_Month4_sh, 
								 TextString.txtCalendar_Month5_sh,
	...
	var DAY_NAMES = new Array( TextString.txtCalendar_day7,
							   TextString.txtCalendar_day1,
							   TextString.txtCalendar_day2, 
							   TextString.txtCalendar_day3, 
							   TextString.txtCalendar_day4, 
							   TextString.txtCalendar_day5,
							   TextString.txtCalendar_day6, 
							   
							   TextString.txtCalendar_day7_sh, 
							   TextString.txtCalendar_day1_sh, 
							   TextString.txtCalendar_day2_sh, 
							   TextString.txtCalendar_day3_sh, 
							   TextString.txtCalendar_day4_sh, 
							   TextString.txtCalendar_day1_sh, 
